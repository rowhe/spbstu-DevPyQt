...
class Window(QtWidgets.QWidget):
    ...
    def initUi(self) -> None:
        ...
        labelLogin = QtWidgets.QLabel("Login")  # TODO Создайте виджет QLabel с текстом "Логин"
        labelRegistration = QtWidgets.QLabel("Registration")  # TODO Создайте виджет QLabel с текстом "Регистрация"

        self.lineEditLogin = QtWidgets.QLineEdit()  # TODO создайте виджет QLineEdit
        self.lineEditLogin.setPlaceholderText('Enter login')  # TODO добавьте placeholderText "Введите логин" с помощью метода .setPlaceholderText()
        self.lineEditPassword = QtWidgets.QLineEdit()  # TODO создайте виджет QLineEdit
        self.lineEditPassword.setPlaceholderText('Enter password')  # TODO добавьте placeholderText "Введите пароль"
        ...
        self.pushButtonLogin.setText("Login")  # TODO установите текст "Войти" с помощью метода setText()

        self.pushButtonRegistration = QtWidgets.QPushButton()  # TODO создайте виджет QPushButton
        self.pushButtonRegistration.setText("Register")  # TODO установите текст "Регистрация" с помощью метода setText()
